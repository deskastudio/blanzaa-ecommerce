...
@section('title', $category->name . ' - Exclusive Electronics Store')
...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center mb-4">
            @if($category->icon)
                <i class="{{ $category->icon }} text-4xl text-red-500 mr-4"></i>
            @endif
            <div>
        ...
        @if($category->description)
            <p class="text-gray-700 max-w-2xl">{{ $category->description }}</p>
        @endif
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        @empty
            <div class="col-span-full text-center py-12">
                ...
                <p class="text-gray-500">This category is empty at the moment.</p>
            </div>
        @endforelse
    </div>
